...
def bedroom_filter(version, room_size, second_tier, source):
    ...
    if version == "final":
        ...
        rejected += ["gym_equipment", "fireplace", "dining_table", "short_kitchen_cabinet",\
                     "hanging_kitchen_cabinet", "refrigerator"]
        filtered += ["pillow", "glass", "cup"]
        filtered, rejected, door_window, second_tier_include = \
        ...
        def node_criteria(node, room):
            ...
            if second_tier:
                ...
                if node.zmin - room.zmin > 0.1:
                    return False
                if category in ["vase", "console", "book", "television", "table_lamp", "fishbowl"]:
                    return False
        ...
        def room_criteria(room, house):
            ...
            #if not scaled:
                #return False
            if floor_node_count < 5 or node_count > 20: return False
            if bed_count < 1: return False
